...
address: "Virtual room TODO"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
helper: ["Mauro Lepore", "Jackson Hoffart"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite: TODO          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
